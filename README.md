...
- Every form has an editable direct URL in the Control Room, such as `/apply`. Direct form URLs are resolved by the GitHub Pages `404.html` fallback and keep the friendly path in the browser.
